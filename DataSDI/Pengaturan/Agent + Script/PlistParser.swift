...
/// File plist akan disimpan di dalam direktori `Application Support` aplikasi, dengan nama `sdi-update.plist` di dalam sub-direktori "DataSDI".
...
class SharedPlist {
    ...
    private init() {
        ...
        let dirURL = appSupport.appendingPathComponent("DataSDI", isDirectory: true)

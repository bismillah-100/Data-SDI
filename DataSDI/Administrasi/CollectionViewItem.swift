...
class CollectionViewItem: NSCollectionViewItem {
    ...
    private var backgroundColor: NSColor = NSColor.clear
    ...
    func updateMark(for entity: Entity) {
        ...
        if let leftMarkerLayer = leftMarkerLayer {
        ...
        switch entity.jenis {
        case "Pengeluaran":
            baseColor = NSColor(red: 1.0, green: 0.5, blue: 0.5, alpha: 1.0) // Warna merah terang
        case "Pemasukan":
            baseColor = NSColor(red: 0.4, green: 0.8, blue: 0.4, alpha: 1.0) // Warna hijau terang
        case "Lainnya":
            baseColor = NSColor(red: 0.9, green: 0.7, blue: 0.4, alpha: 1.0)
        default:
            baseColor = NSColor(red: 0.3, green: 0.7, blue: 0.9, alpha: 1.0) // Warna biru terang
        }

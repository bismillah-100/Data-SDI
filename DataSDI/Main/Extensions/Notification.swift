...
extension Notification.Name {
    ...
    //static let findInsertedKelasId = NSNotification.Name("FindInsertedKelasId")
    ...
    static let findInsertedKelasIdFromKelas = Notification.Name("FindInsertedKelasIdFromKelas")

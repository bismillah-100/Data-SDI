...
class TagControl: NSControl {
    ...
    private func colorName(for color: NSColor) -> String {
        switch color {
        case NSColor(named: "kelas1") ?? NSColor.clear: return "Ubah ke: \"Kelas 1\""
        case NSColor(named: "kelas2") ?? NSColor.clear: return "Ubah ke: \"Kelas 2\""
        case NSColor(named: "kelas3") ?? NSColor.clear: return "Ubah ke: \"Kelas 3\""
        case NSColor(named: "kelas4") ?? NSColor.clear: return "Ubah ke: \"Kelas 4\""
        case NSColor(named: "kelas5") ?? NSColor.clear: return "Ubah ke: \"Kelas 5\""
        case NSColor(named: "kelas6") ?? NSColor.clear: return "Ubah ke: \"Kelas 6\""
        case .systemRed: return "Hapus Kelas Aktif"
        default: return "Kelas Aktif"
        }
    }

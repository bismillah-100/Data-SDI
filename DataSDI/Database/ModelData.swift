...
public class KelasModels: Comparable, NSCopying {
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        return KelasModels(kelasID: kelasID,
                           siswaID: siswaID,
                           namasiswa: namasiswa,
                           mapel: mapel,
                           nilai: nilai,
...
extension Array where Element == Kelas1Model {
...
extension Array where Element == Kelas2Model {
    /// Lihat: ``Swift/Array/insertionIndex(for:using:)-2g3nq``
    func insertionIndex(for element: Element, using sortDescriptor: NSSortDescriptor) -> Index {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd MMMM yyyy"
...
extension Array where Element == Kelas3Model {
    /// Lihat: ``Swift/Array/insertionIndex(for:using:)-2g3nq``
    func insertionIndex(for element: Element, using sortDescriptor: NSSortDescriptor) -> Index {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd MMMM yyyy"
...
extension Array where Element == Kelas4Model {
    /// Lihat: ``Swift/Array/insertionIndex(for:using:)-2g3nq``
    func insertionIndex(for element: Element, using sortDescriptor: NSSortDescriptor) -> Index {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd MMMM yyyy"
...
extension Array where Element == Kelas5Model {
    /// Lihat: ``Swift/Array/insertionIndex(for:using:)-2g3nq``
    func insertionIndex(for element: Element, using sortDescriptor: NSSortDescriptor) -> Index {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd MMMM yyyy"
...
extension Array where Element == Kelas6Model {
    /// Lihat: ``Swift/Array/insertionIndex(for:using:)-2g3nq``
    func insertionIndex(for element: Element, using sortDescriptor: NSSortDescriptor) -> Index {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "dd MMMM yyyy"

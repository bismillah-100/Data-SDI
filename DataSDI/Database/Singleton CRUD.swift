...
class SingletonData {
    ...
    static func dbTable(forTableType tableType: TableType) -> Table? {
        switch tableType {
        case .kelas1:
            return Table("kelas1") // Menginisialisasi objek Table dengan nama tabel "kelas1".
        case .kelas2:
            return Table("kelas2") // Menginisialisasi objek Table dengan nama tabel "kelas2".
        case .kelas3:
            return Table("kelas3") // Menginisialisasi objek Table dengan nama tabel "kelas3".
        case .kelas4:
            return Table("kelas4") // Menginisialisasi objek Table dengan nama tabel "kelas4".
        case .kelas5:
            return Table("kelas5") // Menginisialisasi objek Table dengan nama tabel "kelas5".
        case .kelas6:
            return Table("kelas6") // Menginisialisasi objek Table dengan nama tabel "kelas6".
        }
    }
}
